...
//	      System.out.println("Date after ten year: " + nextDecade);
		...
		LocalDate ld1 = LocalDate.of(2000, Month.MARCH, 29);
		System.out.println(ld1.getDayOfWeek());
		
		LocalDate ld3 = ld1.plus(1,ChronoUnit.YEARS);
		
		System.out.println(ld3.getDayOfWeek());
		String ld4 = ld3.getDayOfWeek().toString();
		
		ld3 = LocalDate.now();
		
		LocalDate d= LocalDate.of(2104, 3, 29); 
